            ...
            <div className="col-lg-6">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">Nhập sản phẩm</h5>
                  {message && (
                    <h5>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic1" />
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Ảnh 2</label>
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic2" />
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Ảnh 3</label>
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic3" />
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Ảnh 4</label>
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic4" />
                    </div>
                  </div>
                  {/* Other fields */}
