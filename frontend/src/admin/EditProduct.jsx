                ...
                <div className="card-body">
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                      <input type="text" className="form-control" name="productName" value={product?.productName}/>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Giá</label>
                    <div className="col-sm-10">
                      <input type="number" className="form-control" name="productPrice" value={product?.price} />
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Số lượng</label>
                    <div className="col-sm-10">
                      <input type="number" className="form-control" name="productQuantity" value={product?.quantity} />
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Loại</label>
                    <div className="col-sm-10">
                        <select className="form-select" aria-label="Default select example" name="category" value={product?.category}>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic1" value={product?.image1}/>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Ảnh 2</label>
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic2" value={product?.image2} />
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Ảnh 3</label>
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic3" value={product?.image3}/>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Ảnh 4</label>
                    <div className="col-sm-10">
                        <input className="form-control" type="text" name="pic4" value={product?.image4}/>
                    </div>
                  </div>
                  {/* Other fields */}
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                      <input type="text" className="form-control" name="processor" value={product?.configuration.processor} />
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Màn hình</label>
                    <div className="col-sm-10">
                      <input type="text" className="form-control" name="screen" value={product?.configuration.screen}/>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Dung lượng RAM</label>
                    <div className="col-sm-10">
                      <input type="number" className="form-control" name="ram" value={product?.configuration.ram}/>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Bộ nhớ</label>
                    <div className="col-sm-10">
                      <input type="number" className="form-control" name="memory" value={product?.configuration.memory}/>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label">Card đồ hoạ</label>
                    <div className="col-sm-10">
                      <input type="text" className="form-control" name="graphicCard" value={product?.configuration.graphicCard} />
                    </div>
                  </div>
